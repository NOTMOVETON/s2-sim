...
- [ ] Кнопка "Edit Scene" переключает режим редактора
- [ ] Кнопки "+ Box", "+ Cylinder", "+ Sphere" добавляют примитивы в центр сцены
- [ ] TransformControls работает для перемещения и вращения примитивов
- [ ] Scale-режим изменяет размеры примитива
- [ ] Панель свойств показывает текущий цвет и размеры выбранного примитива
- [ ] Изменение цвета в панели обновляет цвет меша мгновенно
- [ ] Удаление примитива убирает его из сцены
- [ ] "Применить" (Apply) — примитивы обновляются на сервере немедленно
- [ ] "Сохранить сцену" — YAML-файл обновляется на диске
